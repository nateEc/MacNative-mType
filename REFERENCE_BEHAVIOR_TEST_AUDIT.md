...
| `frontend/__tests__/utils/numbers.spec.ts` | XP 数字呈现 | `ExperiencePresentation.swift`、`CloudSyncView.swift`、`TypingEngineTests.swift` 将千以上 XP 紧凑呈现为一位小数的 `k/m/b…`，并回归边界、舍入与负数符号。 |
