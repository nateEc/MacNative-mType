...
- 原创 English（美式或英式拼写）、Español、Deutsch、Nederlands、Dansk、Norsk bokmål、Svenska、Magyar、Français、Italiano、Português、简体中文、繁體中文、Русский、Українська、Українська (Latin)、日本語（ひらがな）、한국어、Türkçe 与 Polski 离线词库及引语；Latin 模式仅提供 Typebar 自创的 ASCII 离线内容，不将在线西里尔百科文本伪装为 Latin；计时、字数和禅模式还可用中英混合词流，语言选择随测试配置、预设和成绩保存
