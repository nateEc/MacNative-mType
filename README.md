...
- 当前内置键盘图为九十三种：新增 TypeHack、ISRT、ISRT Angle、Engram 与 Engrammer。五项均完整覆盖 47 个 ANSI Base/Shift 位置，TypeHack 与 Engram 保留非标准符号层，Engram 两项在精简提示中仍显示数字行；不复制、打包或运行参考布局资产
...
- 324 个引擎、内容、存储、偏好设置、预设、统计、归档、CSV 导出、账户响应及官方布局矩阵单元测试
