...
- 当前内置键盘图为二百四十一种：新增 ErgolPT、Rulemak 与 Gralmak S，完整保留 ISO/ANSI 物理行、四个修饰层、缺失 AltGr 层回退及 ErgolPT 的 Space Shift `-` 输出。固定官方布局矩阵已达到 236 项精确原生、3 项相关替代、0 项回退；这不代表整个重写范围已经完成，也不复制、打包或运行参考布局资产
- 355 个引擎、内容、存储、偏好设置、预设、统计、归档、CSV 导出、账户响应及官方布局矩阵单元测试
