...
- 原生输入桥会在本机统计已闭合物理按键的按住时长；完成页和历史详情显示平均值、总体波动与样本数，未释放的末键和自动重复不会伪造样本
...
- 312 个引擎、内容、存储、偏好设置、预设、统计、归档、CSV 导出、账户响应及官方布局矩阵单元测试
