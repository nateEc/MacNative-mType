...
- 当前内置键盘图为一百八十三种：新增 Bone、AdNW、Mine、Noted 与 Koy。五项均使用 Neo 系 ISO 实体行，保留各自字母、德语变音符、单层空格键、Base/Shift、AltGr 基础层回退和精简数字行策略，不复制、打包或运行参考布局资产
...
- 342 个引擎、内容、存储、偏好设置、预设、统计、归档、CSV 导出、账户响应及官方布局矩阵单元测试
