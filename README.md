...
- 当前内置键盘图为一百零八种：新增 Middlemak-NH、Foalmak、Quartz、Arensito 与 ARTS。五项均完整覆盖 47 个 ANSI Base/Shift 位置；Foalmak 保留两个句点实体键，Quartz 保留重排数字行并在精简提示中显示，Middlemak-NH 独立于普通 Middlemak；不复制、打包或运行参考布局资产
...
- 327 个引擎、内容、存储、偏好设置、预设、统计、归档、CSV 导出、账户响应及官方布局矩阵单元测试
