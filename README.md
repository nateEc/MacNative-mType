...
- 当前内置键盘图为一百八十八种：新增 3l、Korean、Ekverto B、Sturdy Angle ANSI 与 Sturdy Angle ISO。保留 3l 单层空格/数字键、Korean Jamo、ANSI/ISO 物理差异、完整 Base/Shift、AltGr 基础层回退和精简数字行策略，不复制、打包或运行参考布局资产
...
- 343 个引擎、内容、存储、偏好设置、预设、统计、归档、CSV 导出、账户响应及官方布局矩阵单元测试
