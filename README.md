...
- 可选原创键盘提示：五种布局、七种原生几何样式、关闭/静态/按键反馈/下一键模式、精简/数字行/完整按键集、0.5–3.5 倍大小及小写/大写/空白/动态图例均可持久化；动态图例随 Shift 与 Caps Lock 更新，Option 输入仍由 macOS 处理
...
- 129 个引擎、内容、存储、偏好设置、预设、统计和归档单元测试
