...
- 当前内置键盘图为九十八种：新增 Semimak、Semimak JQ、Semimak JQC、Canary 与 Canary Matrix。五项均完整覆盖 47 个 ANSI Base/Shift 位置，并保留三种 Semimak 的 J/Q/C 差异和两种 Canary 的独立排列；不复制、打包或运行参考布局资产
...
- 325 个引擎、内容、存储、偏好设置、预设、统计、归档、CSV 导出、账户响应及官方布局矩阵单元测试
