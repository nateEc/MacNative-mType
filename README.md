...
- 可保存、应用和删除完整测试预设
- 可用工具栏“命令”、⇧⌘K、与参考一致的 ⇧⌘P，或随快速重开设置变化的 Esc/Tab 搜索并执行重开、模式切换、15/30/60/120 秒、10/25/50/100 词、标点/数字开关、引语长度/收藏/搜索、全部 448 个本机语言与代码入口、历史、预设、数据、同步、好友和设置；配置命令会退出当前挑战，含 Tab 的提示会把动态入口保护为 ⇧Tab
