...
- 当前内置键盘图为一百二十三种：新增 Focal、Zenith、Dhorf、Gust 与 Recurva。五项均完整覆盖 47 个 ANSI Base/Shift 位置；Gust 保留重排方括号数字行，但精简模式始终隐藏该行，需选择“精简（数字行）”或“完整”才显示；不复制、打包或运行参考布局资产
...
- 330 个引擎、内容、存储、偏好设置、预设、统计、归档、CSV 导出、账户响应及官方布局矩阵单元测试
