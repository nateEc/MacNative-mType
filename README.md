...
- 固定参考版本的 446 个官方语言配置 ID 已有可重新生成的机器总账：244 个对应 Typebar 独立选择，202 个数字词表规模变体由同语言选择表达，当前没有未映射 ID；项目不会把规模变体误报成独立一一等价，也不会为补齐规模而复制官方语料
...
- Français 1k／2k／10k 作为三个独立入口使用原创确定性索引词流，保持 1,394／2,041／10,251 的实际规模及长度、大小写、标点、多词和非 ASCII 结构；三档不会重复加入默认混排
