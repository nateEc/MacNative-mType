...
- 当前内置键盘图为一百二十八种：新增 Pine v4、Three、Asset、Dwarf 与 Flaw。五项均完整覆盖 47 个 ANSI Base/Shift 位置；Dwarf 显式保留逗号到 `>`、句号到 `<` 的非标准 Shift 层；不复制、打包或运行参考布局资产
...
- 331 个引擎、内容、存储、偏好设置、预设、统计、归档、CSV 导出、账户响应及官方布局矩阵单元测试
