...
- 当前内置键盘图为一百三十三种：新增 STNDC、UCIEA、Whorf、Whorf 6 与 Whorfmax。五项均完整覆盖 47 个 ANSI Base/Shift 位置；STNDC 与 UCIEA 保留重排数字行、非标准符号层及精简模式数字行；不复制、打包或运行参考布局资产
...
- 332 个引擎、内容、存储、偏好设置、预设、统计、归档、CSV 导出、账户响应及官方布局矩阵单元测试
