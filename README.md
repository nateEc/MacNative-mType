...
- 当前内置键盘图为一百六十八种：新增 Redaktor、JUIYAF、Zubachev、Colemak Qi;x 与 Colemak Qi。五项完整保留 47 个 ANSI Base/Shift 位置、重排数字符号层和 AltGr 基础层回退；非标准 Cyrillic 大小写配对按精确输出优先反查，不复制、打包或运行参考布局资产
...
- 339 个引擎、内容、存储、偏好设置、预设、统计、归档、CSV 导出、账户响应及官方布局矩阵单元测试
