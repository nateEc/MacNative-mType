...
- 当前内置键盘图为一百七十三种：新增 ColemaQ、ColemaQ F、Thai Manoonchai、Brasileiro Nativo 与 BEAKL 15。五项完整保留 Base/Shift 和 AltGr 基础层回退；Brasileiro Nativo 使用 ISO 实体行，Manoonchai 的组合符保持独立按键，并保留各自精简数字行策略，不复制、打包或运行参考布局资产
...
- 340 个引擎、内容、存储、偏好设置、预设、统计、归档、CSV 导出、账户响应及官方布局矩阵单元测试
