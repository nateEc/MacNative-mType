...
- 可保存、应用和删除完整测试预设
- 原创离线挑战会在完成页逐项验收最低或精确 WPM、精确 Raw、准确率、打字稳定度、最小时长、AFK 比例、错误数、精确 funbox 集合，以及结果快照中的模式、语言、难度、标点和数字；所有挑战默认限制 AFK 不超过 10%，也可收紧。挑战脚本、文案与内容均为 Typebar 自有，不复制参考项目资产
...
- 552 个引擎、内容、存储、偏好设置、预设、统计、归档、CSV 导出、账户响应、挑战条件、命令目录及官方布局矩阵单元测试
