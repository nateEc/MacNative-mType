...
- 当前内置键盘图为一百四十三种：新增 Nila、Noctum、Cascade、Vylet 与 Romak。五项均完整覆盖 47 个 ANSI Base/Shift 位置，并保留 Cascade 与 Vylet 的非标准逗号/句点 Shift 配对；不复制、打包或运行参考布局资产
...
- 334 个引擎、内容、存储、偏好设置、预设、统计、归档、CSV 导出、账户响应及官方布局矩阵单元测试
