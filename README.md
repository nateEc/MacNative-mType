...
- 当前内置键盘图为一百零三种：新增 Boo、Boo Mangle、APT、APT Angle 与 Middlemak。五项均完整覆盖 47 个 ANSI Base/Shift 位置；Boo 两项保留非标准符号层，Boo Mangle 在精简提示中仍显示数字行，APT Angle 保留独立底行；不复制、打包或运行参考布局资产
...
- 326 个引擎、内容、存储、偏好设置、预设、统计、归档、CSV 导出、账户响应及官方布局矩阵单元测试
