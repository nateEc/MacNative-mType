...
- 当前内置键盘图为一百四十八种：新增 Scythe、Inqwerted、Rain、Night 与 Night STIC。五项均完整覆盖 47 个 ANSI Base/Shift 位置，并保留 Night 的重排数字行；不复制、打包或运行参考布局资产
...
- 335 个引擎、内容、存储、偏好设置、预设、统计、归档、CSV 导出、账户响应及官方布局矩阵单元测试
