...
enum LivePracticeContentService {
  ...
  static func wikipediaLanguageCode(for language: TypingLanguage) -> String {
    ...
    case .german, .german1k, .german10k, .german250k, .swissGerman: return "de"
    ...
    case .bangla, .banglaLetters: return "bn"
    case .thai: return "th"
    ...
    case .russian, .russianAbbreviations, .russianContractions, .russianContractions1k: return "ru"
