...
enum OfflineContent {
  ...
  static let quotes = [
    ...
    OfflineQuote(
      id: "kokanu-pata-jan",
      title: "pata jan",
      text: "men mi le pata in pata jan. ja le teka in kuwosi sepo un pawo hunsi.",
      language: .kokanu,
      length: .medium
    ),
    OfflineQuote(
      id: "kokanu-wisan-tope",
      title: "wisan tope",
      text: "mi le lo pi tope jan un tu le kota ki mi. men ja le wisan in pawo kusa, un mi le teka in kuwosi wanku. usen le kanisa wiki in konen.",
      language: .kokanu,
      length: .long
    ),
    OfflineQuote(
      id: "kokanu-pumi-patun",
      title: "pumi patun",
      text: "men mi le lo pi pumi patun wija pata jan. tu le kota wiki ki mi, un ja le wisan in konen sikin. men usen le teka in kuwosi sepo un ukama. mi le no makan wiki; mi le pata in pata, le kanisa in tope jan, un le lo pi pawo hunsi. ja le kota ki tu un mi, un usen le wisan in usen.",
      language: .kokanu,
      length: .extended
    ),
    OfflineQuote(
    ...
    OfflineQuote(
      id: "kazakh-calm-step",
      title: "Тыныш қадам",
      text: "Тыныш қадам келесі істі айқынырақ етеді.",
      language: .kazakh,
      length: .short
    ),
    OfflineQuote(
      id: "kazakh-open-page",
      title: "Ашық бет",
      text: "Ашық бет барлық сұраққа жауап бермейді, бірақ жаңа ойға орын қалдырады.",
      language: .kazakh,
      length: .medium
    ),
    OfflineQuote(
      id: "kazakh-small-effort",
      title: "Шағын талпыныс",
      text: "Бүгінгі шағын талпыныс бәрін аяқтауы керек емес. Кітапты аш, бір сөйлемді түзет те, ертеңге пайдалы белгі қалдыр. Уақыт өте келе осы шағын қадамдар бастауды жеңілдетеді.",
      language: .kazakh,
      length: .long
    ),
    OfflineQuote(
      id: "kazakh-return-place",
      title: "Қайта оралатын орын",
      text: "Күннің соңында шағын кітап толық жауап сұрамайды. Онда жарты сөйлем, бір сұрақ және келесі талпынысқа арналған қысқа белгі қалуы мүмкін. Бұл қайта оралатын орынды дайындауға жеткілікті. Қайта қарағанда, ойдың сәл ілгерілегенін және бастаманың алыста емес екенін көресің. Әрбір тыныш қадам жолда бір белгі қалдырады, ал сол белгілер үлкен істі шағын бөліктерде ұстауға болатынын көрсетеді.",
      language: .kazakh,
      length: .extended
    ),
    OfflineQuote(
    ...
    OfflineQuote(
      id: "tibetan-clear-step",
      title: "རིམ་པ་གསལ་པོ་",
      text: "རིམ་པ་ཆུང་ཆུང་ཞིག་གིས་འགོ་གསལ་པོ་བཟོ་ཐུབ།",
      language: .tibetan,
      length: .short
    ),
    OfflineQuote(
      id: "tibetan-open-book",
      title: "དཔེ་ཆ་ཁ་ཕྱེ་",
      text: "དཔེ་ཆ་ཁ་ཕྱེ་བས་ལན་ཚང་མ་མི་སྟེར་ཡང་བསམ་པ་གསར་པ་ཞིག་འགོ་ཚུགས།",
      language: .tibetan,
      length: .medium
    ),
    OfflineQuote(
      id: "tibetan-small-work",
      title: "ལས་ཆུང་ཆུང་",
      text: "ལས་ཀ་བཟང་པོ་ཞིག་ལ་འགོ་ནས་ཚང་མ་རྫོགས་པ་དགོས་པ་མེད། ཤོག་བུ་ཞིག་ཕྱེ། ཚིག་གཅིག་བྲིས། བསམ་པར་དུས་ཚོད་སྤྲོད། དེ་རིང་གི་རིམ་པ་ཆུང་ཆུང་གིས་སང་ཉིན་ལམ་གསལ་པོ་བཟོ་ཐུབ།",
      language: .tibetan,
      length: .long
    ),
    OfflineQuote(
      id: "tibetan-return-page",
      title: "ཤོག་བུར་ལོག་པ་",
      text: "ཉིན་མཐའ་མར་འཆར་གཞི་ཆུང་ཆུང་ཞིག་ཆ་ཚང་བ་དགོས་པ་མེད། དེས་དྲི་བ་ཞིག་དང་ལོག་ནས་ཀློག་རྒྱུའི་ཚིག་ཅིག་སང་ཉིན་གྱི་ཟིན་བྲིས་ཐུང་ཐུང་ཞིག་འཇོག་ཐུབ། དོན་ཆུང་ཆུང་དེ་དག་གིས་ལས་ཀར་ལམ་སྟོན། ཤོག་བུར་ཡང་བསྐྱར་ལོག་དུས་བསམ་པ་སྔར་ནས་མདུན་དུ་སོང་བ་དང་འགོ་རྩོམ་པ་དེ་དཀའ་བ་མིན་པ་མཐོང་ཐུབ། རིམ་པ་གསལ་པོ་ཞིག་གིས་ལས་ཀའི་འགོ་འཛིན་པར་རོགས་བྱེད།",
      language: .tibetan,
      length: .extended
    ),
    OfflineQuote(
    ...
    OfflineQuote(
      id: "yiddish-open-book",
      title: "אַן אָפֿן בוך",
      text: "אַן אָפֿן בוך ענטפֿערט ניט אויף יעדע פֿראַגע, אָבער עס עפֿנט אַ וועג צו אַ נײַעם געדאַנק.",
      language: .yiddish,
      length: .medium
    ),
    OfflineQuote(
      id: "yiddish-small-work",
      title: "קליינע אַרבעט",
      text: "אַ גוטע אַרבעט דאַרף ניט זײַן גרייט פֿון אָנהייב אָן. עפֿן דעם בלאַט, שרײַב איין וואָרט, און לאָז דעם געדאַנק געפֿינען זײַן וועג. דער קליינער שריט פֿון הייַנט מאַכט מאָרגן לייכטער.",
      language: .yiddish,
      length: .long
    ),
    OfflineQuote(
      id: "yiddish-return-page",
      title: "צוריק צום בלאַט",
      text: "ווען דער טאָג ענדיקט זיך, דאַרף אַ קליינער פּלאַן ניט זײַן גאַנץ. ער קען לאָזן אַ פֿראַגע, איין וואָרט צו לייענען ווידער, און אַ קורצן צייכן פֿאַר מאָרגן. אַזעלכע קליינע זאַכן געבן דער אַרבעט אַ ריכטונג. ווען דו קערסט צוריק צום בלאַט, זעסטו אַז דער געדאַנק איז שוין געגאַנגען ווייטער און אַז אָנהייבן איז ניט אַזוי שווער. אַ קליינער קלאָרער שריט העלפֿט דער אַרבעט ווײַטער גיין.",
      language: .yiddish,
      length: .extended
    ),
    OfflineQuote(
    ...
    OfflineQuote(
      id: "bangla-letters-one-symbol",
      title: "একটি অক্ষর",
      text: "একটি অক্ষর মন দিয়ে দেখে তারপর ধীরে টাইপ করুন।",
      language: .banglaLetters,
      length: .short
    ),
    OfflineQuote(
      id: "bangla-letters-shape-and-sound",
      title: "আকার ও ধ্বনি",
      text: "বাংলা অক্ষরের রেখা, মাত্রা ও ধ্বনি আলাদা করে লক্ষ্য করুন। প্রতিটি চিহ্ন পরিষ্কারভাবে চিনে নিয়ে শান্ত ছন্দে পরেরটিতে যান।",
      language: .banglaLetters,
      length: .medium
    ),
    OfflineQuote(
      id: "bangla-letters-steady-sequence",
      title: "স্থির ক্রম",
      text: "অক্ষর অনুশীলনের সময় দ্রুত শেষ করার চেয়ে সঠিক ক্রম মনে রাখা বেশি জরুরি। প্রথমে চিহ্নটি দেখুন, তারপর কীবোর্ডে তার অবস্থান খুঁজুন এবং একবারে একটি ইনপুট দিন। যুক্ত অক্ষর এলে প্রতিটি অংশ আলাদা করে বুঝে নিয়ে সম্পূর্ণ রূপটি টাইপ করুন।",
      language: .banglaLetters,
      length: .long
    ),
    OfflineQuote(
      id: "bangla-letters-practice-page",
      title: "অনুশীলনের পাতা",
      text: "অনুশীলনের পাতায় স্বরবর্ণ, ব্যঞ্জনবর্ণ, মাত্রা এবং কয়েকটি যুক্ত রূপ আলাদা সারিতে রাখা আছে। প্রথম সারি ধীরে পড়ুন এবং প্রতিটি অক্ষরের আকার মনে রাখুন। দ্বিতীয় সারিতে একই ছন্দ বজায় রেখে কীবোর্ডের অবস্থান খুঁজুন। কোনো রূপ ভুল হলে তাড়াহুড়ো করে সামনে যাবেন না; ভুল অংশটি মুছে আবার সম্পূর্ণ ক্রমটি লিখুন। নিয়মিত ছোট অনুশীলন চোখ, হাত ও স্মৃতির মধ্যে স্থির সম্পর্ক তৈরি করে এবং দীর্ঘ শব্দ টাইপ করাও পরে সহজ হয়ে ওঠে।",
      language: .banglaLetters,
      length: .extended
    ),
    OfflineQuote(
  ...
  static func quotes(for language: TypingLanguage, length: QuoteLength = .all) -> [OfflineQuote] {
    ...
    case .bulgarianLatin1k: .bulgarianLatin
    case .bosnian4k: .bosnian
    case .albanian1k: .albanian
    case .macedonian1k, .macedonian10k, .macedonian75k: .macedonian
    ...
    case .esperanto1k, .esperanto10k, .esperanto25k, .esperanto36k: .esperanto
    case .esperantoXSystem1k, .esperantoXSystem10k,
    ...
    case .tatarCrimean1k, .tatarCrimean5k, .tatarCrimean10k, .tatarCrimean15k:
      .tatarCrimean
    case .tatarCrimeanCyrillic1k, .tatarCrimeanCyrillic5k,
    ...
    case .irish1k: .irish
    case .filipino1k: .filipino
    case .hungarian1k, .hungarian2k: .hungarian
    case .welsh1k: .welsh
    ...
    if language == .mongolian10k {
      return quotes(for: .mongolian, length: length).map { quote in
        .init(
          id: "mongolian10k-\(quote.id)", title: quote.title, text: quote.text,
          language: language, length: quote.length)
      }
    }
    if language == .malagasy1k {
      return quotes(for: .malagasy, length: length).map { quote in
        .init(
          id: "malagasy1k-\(quote.id)", title: quote.title, text: quote.text,
          language: language, length: quote.length)
      }
    }
    if language == .malay1k {
      return quotes(for: .malay, length: length).map { quote in
        .init(
          id: "malay1k-\(quote.id)", title: quote.title, text: quote.text,
          language: language, length: quote.length)
      }
    }
    if language == .azerbaijani1k {
      return quotes(for: .azerbaijani, length: length).map { quote in
        .init(
          id: "azerbaijani1k-\(quote.id)", title: quote.title, text: quote.text,
          language: language, length: quote.length)
      }
    }
    if language == .nepali1k {
      return quotes(for: .nepali, length: length).map { quote in
        .init(
          id: "nepali1k-\(quote.id)", title: quote.title, text: quote.text,
          language: language, length: quote.length)
      }
    }
    if [
      ...
      return quotes(for: .traditionalChinese, length: length).map { quote in
        .init(
          id: "\(language.rawValue)-\(quote.id)", title: quote.title, text: quote.text,
          language: language, length: quote.length)
      }
    ...
    if [
      ...
      return quotes(for: .norwegianNynorsk, length: length).map { quote in
        .init(
          id: "\(language.rawValue)-\(quote.id)", title: quote.title, text: quote.text,
          language: language, length: quote.length)
      }
    ...
    if [
      .norwegianBokmal1k, .norwegianBokmal5k, .norwegianBokmal10k,
      .norwegianBokmal150k, .norwegianBokmal600k,
    ].contains(language) {
      return quotes(for: .norwegianBokmal, length: length).map { quote in
        .init(
          id: "\(language.rawValue)-\(quote.id)", title: quote.title, text: quote.text,
          language: language, length: quote.length)
      }
    }
    if [.thai1k, .thai5k, .thai10k, .thai20k, .thai50k, .thai60k].contains(language) {
      return quotes(for: .thai, length: length).map { quote in
        .init(
          id: "\(language.rawValue)-\(quote.id)", title: quote.title, text: quote.text,
          language: language, length: quote.length)
      }
    ...
    if language == .arabicEgypt1k {
      return quotes(for: .arabicEgypt, length: length).map { quote in
        .init(
          id: "\(language.rawValue)-\(quote.id)", title: quote.title, text: quote.text,
          language: language, length: quote.length)
      }
    ...
    if [
      .belarusian1k, .belarusian5k, .belarusian10k, .belarusian25k,
      .belarusian50k, .belarusian100k,
    ].contains(language) {
      return quotes(for: .belarusian, length: length).map { quote in
        .init(
          id: "\(language.rawValue)-\(quote.id)", title: quote.title, text: quote.text,
          language: language, length: quote.length)
      }
    }
    if [.polish2k, .polish5k, .polish10k, .polish20k, .polish40k, .polish200k]
      .contains(language)
    {
      return quotes(for: .polish, length: length).map { quote in
        .init(
          id: "\(language.rawValue)-\(quote.id)", title: quote.title, text: quote.text,
          language: language, length: quote.length)
      }
    ...
    if [
      ...
      return quotes(for: .romanian, length: length).map { quote in
        .init(
          id: "\(language.rawValue)-\(quote.id)", title: quote.title, text: quote.text,
          language: language, length: quote.length)
      }
    }
    if [.german1k, .german10k, .german250k].contains(language) {
    ...
    if [.spanish1k, .spanish10k, .spanish650k].contains(language) {
      return quotes(for: .spanish, length: length).map { quote in
        .init(
          id: "\(language.rawValue)-\(quote.id)", title: quote.title, text: quote.text,
          language: language, length: quote.length)
      }
    }
    if [.english1k, .english5k, .english10k, .english25k, .english450k].contains(language) {
