...
extension TypingLanguage {
  ...
  var zipfFrequencySupport: ZipfFrequencySupport {
    switch self {
    case .english, .bosnian, .esperanto, .esperantoHSystem, .tatar, .oromo, .bashkir, .tamil, .kannada, .greeklish, .norwegianBokmal, .norwegianNynorsk,
