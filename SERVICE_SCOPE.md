...
- 排行榜：经过服务端验证的结果提交、全局/每日/昨日/好友 WPM 榜与 ISO 本周 XP 榜，以及常规会话的自身排名。
- 内容：引语提交、收藏、评分、审核与举报。
