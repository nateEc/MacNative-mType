...
final class HealthRouteTests: XCTestCase {
  ...
  func testQuoteSubmissionRequiresValidContentAndStartsPending() async throws {
    ...
    XCTAssertEqual(
      ...
      Set([
        ...
        norwegianBokmalSubmission.id, hungarianSubmission.id, frenchSubmission.id,
  ...
  func testResultsRejectImpossibleOrMalformedValues() async throws {
    ...
    for (offset, language) in [
      "traditionalChinese", "dutch", "danish", "norwegianBokmal", "hungarian", "russian",
      "ukrainian", "ukrainianLatin", "japaneseHiragana", "korean",
      "turkish", "polish",
    ].enumerated() {
