...
public actor AuthStore {
    ...
    throws -> QuoteSubmissionResponse
  {
    ...
    guard
      Set([
        "english", "spanish", "german", "greek", "dutch", "danish", "norwegianBokmal", "swedish", "hungarian", "czech", "slovak", "bulgarian", "romanian", "finnish", "estonian", "icelandic", "french", "italian", "portuguese",
        "simplifiedChinese",
