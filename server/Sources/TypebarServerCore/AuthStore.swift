...
public actor AuthStore {
    ...
    throws -> QuoteSubmissionResponse
  {
    ...
    guard
      Set([
        "english", "spanish", "german", "greek", "dutch", "danish", "norwegianBokmal", "swedish", "hungarian", "czech", "slovak", "slovenian", "croatian", "serbian", "serbianLatin", "bulgarian", "romanian", "finnish", "estonian", "icelandic", "french", "italian", "portuguese",
        "simplifiedChinese",
