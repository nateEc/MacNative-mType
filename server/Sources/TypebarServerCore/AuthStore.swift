...
public actor AuthStore {
    ...
    throws -> QuoteSubmissionResponse
  {
    ...
    guard
      Set([
        "english", "spanish", "german", "afrikaans", "greek", "greeklish", "dutch", "filipino", "catalan", "indonesian", "danish", "norwegianBokmal", "norwegianNynorsk", "swedish", "hungarian", "czech", "slovak", "slovenian", "croatian", "serbian", "serbianLatin", "bulgarian", "romanian", "finnish", "estonian", "icelandic", "french", "italian", "portuguese",
        "simplifiedChinese",
