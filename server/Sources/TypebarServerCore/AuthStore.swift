...
public actor AuthStore {
  ...
  private static let supportedSingleLanguageIDs: Set<String> = [
    "english", "spanish", "german", "afrikaans", "arabic", "hebrew", "persian", "urdu", "tamil", "hindi", "gujarati", "bangla", "thai", "nepali", "kannada", "telugu", "malayalam", "sanskrit", "sinhala", "greek", "greeklish", "dutch", "filipino",
