...
public actor AuthStore {
  ...
  static let supportedSingleLanguageIDs: Set<String> = [
    ...
    "arabic10k", "arabicEgypt1k",
    "korean1k", "korean5k",
    "thai1k", "thai5k", "thai10k", "thai20k", "thai50k", "thai60k",
    ...
    "italian1k", "italian7k", "italian60k", "italian280k",
    ...
    "hebrew1k", "hebrew5k", "hebrew10k",
    "persian1k", "persian5k", "persian20k", "urdu1k", "urdu5k",
    "tamil1k", "telugu1k", "bangla10k", "hindi1k", "gujarati1k",
    "turkish1k", "turkish5k", "kazakh1k", "kyrgyz1k",
    "tatar1k", "tatar5k", "tatar9k", "uzbek1k", "uzbek70k",
    "dutch1k", "dutch10k", "czech1k", "czech10k",
    "slovak1k", "slovak10k", "slovenian1k", "slovenian5k", "croatian1k",
    "danish1k", "danish10k", "swedish1k", "finnish1k", "finnish10k",
    "estonian1k", "estonian5k", "estonian10k", "icelandic1k",
    "irish1k", "filipino1k", "hungarian1k", "hungarian2k", "welsh1k",
    ...
    "amharic1k", "amharic5k", "armenian1k", "armenianWestern1k",
    "belarusianLacinka1k", "hawaiian1k", "japaneseRomaji1k", "klingon1k",
    "oromo1k", "oromo5k", "shona1k", "tibetan1k", "englishFiveLetter1k", "xhosa3k",
    ...
    "polish2k", "polish5k", "polish10k", "polish20k", "polish40k", "polish200k",
    "belarusian1k", "belarusian5k", "belarusian10k", "belarusian25k", "belarusian50k", "belarusian100k",
  ...
  /// Reversibly removes an account from shared leaderboard calculations. The
  /// route layer authorizes the deployment key; results and login access stay
  /// intact so restoring this flag makes existing results eligible again.
  public func setLeaderboardRestricted(userID: UUID, restricted: Bool) throws
    -> LeaderboardRestrictionResponse
  {
    guard let index = state.users.firstIndex(where: { $0.id == userID }) else {
      throw AuthStoreError.profileNotFound
    }
    if state.users[index].leaderboardRestricted != restricted {
      state.users[index].leaderboardRestricted = restricted
      try persist()
    }
