...
public actor AuthStore {
  ...
  private static let supportedSingleLanguageIDs: Set<String> = [
    "english", "spanish", "german", "afrikaans", "azerbaijani", "belarusian", "lithuanian", "kurdishCentral", "arabic", "hebrew", "persian", "urdu", "tamil", "hindi", "gujarati", "bangla", "thai", "nepali", "kannada", "telugu", "malayalam", "sanskrit", "sinhala", "khmer", "myanmarBurmese", "lao", "amharic", "armenian", "georgian", "greek", "greeklish", "dutch", "filipino",
