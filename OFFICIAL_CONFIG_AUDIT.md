...
2026-09-09 当前更正：上表 `language` 行的有效快照进一步更新为 168 种单语，默认／自选 LTR 多语候选仍为 153 种。English 1k／5k／10k／25k／450k 已从相关映射提升为五个独立入口，以惰性初始化的原创确定性词流保持 1,000／5,000／9,944／24,141／450,029 实际规模及各自长度、大小写、符号和词频排序元数据；机器总账为 446／238／208／0，不导入参考词值、代码或资产。
