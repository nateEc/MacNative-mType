...
- 当前语言目录：241 个可单独练习的语言或书写方式、70 个代码选择和 2 个混合入口。
- `Compatibility/official-languages.json` 对固定 schema 的 446 个语言 ID 做机器守恒：311 个独立原生选择、135 个由同语言选择表达的数字规模变体、0 个未映射配置。该清单只从 schema ID 和本地枚举生成，不读取官方语言词值；完整边界见 `OFFICIAL_LANGUAGE_AUDIT.md`。
